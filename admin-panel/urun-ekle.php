                        ...
                        <div class="min-w-0 p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                            <form enctype="multipart/form-data" method="POST">
                                ...
                                <label class="block mt-4 text-sm">
                                    ...
                                    <input type="text" name="urun-fiyat" maxlength="5" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Örn: 300" required />
                                </label>
